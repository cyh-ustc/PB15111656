...
class PlusFirstParser ( Parser ):
    ...
    class IntContext(EContext):
        ...
        def INT(self):
            return self.getToken(PlusFirstParser.INT, 0)
    ...
    def e(self, _p:int=0):
        ...
        try:
            ...
            if token in [PlusFirstParser.T__2]:
                localctx = PlusFirstParser.BarcContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx

                self.state = 3
                self.match(PlusFirstParser.T__2)
                self.state = 4
                self.e(0)
                self.state = 5
                self.match(PlusFirstParser.T__3)
                pass
            elif token in [PlusFirstParser.INT]:
                localctx = PlusFirstParser.IntContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                self.state = 7
                self.match(PlusFirstParser.INT)
                pass
            else:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = PlusFirstParser.AddContext(self, PlusFirstParser.EContext(self, _parentctx, _parentState))
                        ...
                        self.state = 11
                        self.match(PlusFirstParser.T__0)
                        self.state = 12
                        self.e(5)
                        pass
                        ...
                        self.state = 14
                        self.match(PlusFirstParser.T__1)
                        self.state = 15
                        self.e(4)
                        pass
